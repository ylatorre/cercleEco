 ...
 */
final class Version20241107134535 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE day_quest_user (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, day_quest_id INT DEFAULT NULL, etat INT DEFAULT NULL, INDEX IDX_A519FA64A76ED395 (user_id), INDEX IDX_A519FA6423D0B988 (day_quest_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
